...
VOYAGE_API_RETRY_COUNT = _env_int("VOYAGE_API_RETRY_COUNT", 2)
VOYAGE_API_RETRY_BACKOFF_SECONDS = _env_int("VOYAGE_API_RETRY_BACKOFF_SECONDS", 3)
...
CANDIDATE_MAX_COUNT = _env_int("CANDIDATE_MAX_COUNT", 16)
PROOF_REFINEMENT_MAX_ROUNDS = _env_int("PROOF_REFINEMENT_MAX_ROUNDS", 5)
